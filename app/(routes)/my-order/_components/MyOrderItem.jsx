...
function MyOrderItem({orderItm}) {
  return (
    ...
    <div className='grid grid-cols-5  p-2  items-center border-bottom'>
      <img src={`${process.env.NEXT_PUBLIC_BACKEND_BASE_URL}${orderItm.product.data.attributes.image.data[0].attributes?.url}`} alt={orderItm.product.data.attributes.name} width={80} height={80} className='bg-gray-100 p-5 rounded-lg border'/>
